...
export const QT0068_QUOTE_CARD_STRUCTURE = {
  "version": 2,
      ...
      "fields": [
        {
          ...
          "isSubtotal": false,
          "defaultValue": "",
          "defaultSource": {"path": "$bom_view._料件", "type": "BASIC_DATA"}
        },
        {
          "name": "组成数量",
          "label": "组成数量",
          ...
          "isSubtotal": false,
          "defaultValue": "",
          "defaultSource": {"path": "$bom_view._组成数量", "type": "BASIC_DATA"}
        },
        {
          "name": "产出类型",
          "label": "产出类型",
          ...
          "isSubtotal": false,
          "defaultValue": "",
          "defaultSource": {"path": "$bom_view._产出类型", "type": "BASIC_DATA"}
        },
        {
          "name": "材料毛重",
          "label": "材料毛重",
          ...
          "isSubtotal": false,
          "defaultValue": "",
          "defaultSource": {"path": "$bom_view._材料毛重", "type": "BASIC_DATA"},
          "unitSourceField": "单位"
        },
        {
          "name": "材料净重",
          ...
          "isSubtotal": false,
          "defaultValue": "",
          "defaultSource": {"path": "$bom_view._材料净重", "type": "BASIC_DATA"},
          "unitSourceField": "单位"
        },
        {
          "name": "单位",
          ...
          "isSubtotal": false,
          "defaultValue": "",
          "defaultSource": {"path": "$bom_view._单位", "type": "BASIC_DATA"}
        },
        {
          "name": "材料占比",
          "label": "材料占比",
          ...
          "isSubtotal": false,
          "defaultValue": "",
          "defaultSource": {"path": "$bom_view._材料占比", "type": "BASIC_DATA"}
        },
        {
          "name": "损耗率",
          "label": "损耗率",
          ...
          "isSubtotal": false,
          "defaultValue": "",
          "defaultSource": {"path": "$bom_view._损耗率", "type": "BASIC_DATA"}
        },
        {
          "name": "来料回收费",
          "label": "来料回收费",
        ...
        },
        {
          ...
          "isSubtotal": true,
          "defaultValue": "",
          "conditionalFormula": {"rules": [{"when": {"kind": "group", "logic": "and", "children": [{"op": "eq", "rhs": {"type": "literal", "value": "非银点类"}, "kind": "leaf", "left": "产出类型"}]}, "formula": "非银点类材料成本公式", "formula_id": "cb3ea05c-74d4-4a69-870f-79cd5b74376a"}], "default": "银点材料成本公式", "default_formula_id": "c9213b82-cd55-484d-87e1-f9d95c13718f"}
        },
        {
          "name": "材料损耗成本",
          "label": "材料损耗成本",
        ...
        },
        {
          ...
          "isSubtotal": false,
          "defaultValue": "",
          "defaultSource": {"path": "$bom_view._回收价格", "type": "BASIC_DATA"}
        },
        {
          "name": "回收成本",
          "label": "回收成本",
      ...
      "fields": [
        {
          ...
          "isSubtotal": false,
          "defaultValue": "",
          "defaultSource": {"path": "$mc_view._销售料号", "type": "BASIC_DATA"}
        },
        {
          "name": "料号",
          "label": "料号",
          ...
          "isSubtotal": false,
          "defaultValue": "",
          "defaultSource": {"path": "$mc_view._料号", "type": "BASIC_DATA"}
        },
        {
          "name": "料件",
          "label": "料件",
          ...
          "isSubtotal": false,
          "defaultValue": "",
          "defaultSource": {"path": "$mc_view._料件", "type": "BASIC_DATA"}
        },
        {
          "name": "项次",
          "label": "项次",
          ...
          "isSubtotal": false,
          "defaultValue": "",
          "defaultSource": {"path": "$mc_view._项次", "type": "BASIC_DATA"}
        },
        {
          "name": "元素",
          "label": "元素",
          ...
          "isSubtotal": false,
          "defaultValue": "",
          "defaultSource": {"path": "$mc_view._元素", "type": "BASIC_DATA"}
        },
        {
          "name": "组成含量(%)",
          "label": "组成含量(%)",
          ...
          "isSubtotal": false,
          "defaultValue": "",
          "defaultSource": {"path": "$mc_view._组成含量", "type": "BASIC_DATA"}
        },
        {
          "name": "损耗率%",
          "label": "损耗率%",
          ...
          "isSubtotal": false,
          "defaultValue": "",
          "defaultSource": {"path": "$mc_view._损耗率", "type": "BASIC_DATA"}
        },
        {
          "name": "毛重",
          "label": "毛重",
          ...
          "isSubtotal": false,
          "defaultValue": "",
          "defaultSource": {"path": "$mc_view._毛重", "type": "BASIC_DATA"},
        ...
        },
        {
          ...
          "isSubtotal": false,
          "defaultValue": "",
          "defaultSource": {"path": "$mc_view._毛用量单位", "type": "BASIC_DATA"}
        },
        {
          "name": "元素单价",
          "label": "元素单价",
          ...
          "isSubtotal": false,
          "defaultValue": "",
          "defaultSource": {"path": "$mc_view.元素单价", "type": "BASIC_DATA"}
        },
        {
          "name": "货币",
          "label": "货币",
          ...
          "isSubtotal": false,
          "defaultValue": "",
          "defaultSource": {"path": "$mc_view.货币", "type": "BASIC_DATA"}
        }
      ],
      "tabName": "材料成本",
      "formulas": [],
      ...
      "fields": [
        {
          ...
          "isSubtotal": false,
          "defaultValue": "",
          "defaultSource": {"path": "$ll_view._销售料号", "type": "BASIC_DATA"}
        },
        {
          "name": "料件",
          "label": "料件",
          ...
          "isSubtotal": false,
          "defaultValue": "",
          "defaultSource": {"path": "$ll_view._料件", "type": "BASIC_DATA"}
        },
        {
          "name": "项次",
          "label": "项次",
          ...
          "isSubtotal": false,
          "defaultValue": "",
          "defaultSource": {"path": "$ll_view._项次", "type": "BASIC_DATA"}
        },
        {
          "name": "加工费",
          "label": "加工费",
          ...
          "isSubtotal": false,
          "defaultValue": "",
          "defaultSource": {"path": "$ll_view._加工费", "type": "BASIC_DATA"},
          "unitSourceField": "单位"
        },
        {
          "name": "单位",
          ...
          "isSubtotal": false,
          "defaultValue": "",
          "defaultSource": {"path": "$ll_view._单位", "type": "BASIC_DATA"}
        }
      ],
      "tabName": "来料固定加工费",
      "formulas": [],
      ...
      "fields": [
        {
          ...
          "isSubtotal": false,
          "defaultValue": "",
          "defaultSource": {"path": "$lqt_view._销售料号", "type": "BASIC_DATA"}
        },
        {
          "name": "料号",
          "label": "料号",
          ...
          "isSubtotal": false,
          "defaultValue": "",
          "defaultSource": {"path": "$lqt_view._料号", "type": "BASIC_DATA"}
        },
        {
          "name": "料件",
          "label": "料件",
          ...
          "isSubtotal": false,
          "defaultValue": "",
          "defaultSource": {"path": "$lqt_view._料件", "type": "BASIC_DATA"}
        },
        {
          "name": "项次",
          "label": "项次",
          ...
          "isSubtotal": false,
          "defaultValue": "",
          "defaultSource": {"path": "$lqt_view._项次", "type": "BASIC_DATA"}
        },
        {
          "name": "要素",
          "label": "要素",
          ...
          "isSubtotal": false,
          "defaultValue": "",
          "defaultSource": {"path": "$lqt_view._要素", "type": "BASIC_DATA"}
        },
        {
          "name": "费用",
          "label": "费用",
          ...
          "isSubtotal": false,
          "defaultValue": "",
          "defaultSource": {"path": "$lqt_view._费用", "type": "BASIC_DATA"},
        ...
        },
        {
          ...
          "isSubtotal": false,
          "defaultValue": "",
          "defaultSource": {"path": "$lqt_view._比例", "type": "BASIC_DATA"}
        },
        {
          "name": "计价单位",
          "label": "计价单位",
          ...
          "isSubtotal": false,
          "defaultValue": "",
          "defaultSource": {"path": "$lqt_view._计价单位", "type": "BASIC_DATA"}
        }
      ],
      "tabName": "来料其他费用",
      "formulas": [],
