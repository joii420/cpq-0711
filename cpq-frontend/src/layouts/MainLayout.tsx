...
// - 主数据维护 = 壳页 /master-data-hub (task-0728 起 4 Tab: 料号核价/材质/元素/工序; 「导入核价数据」按钮已移入料号核价页签内)
...
//   产品分类管理 (并入产品管理按钮)
// - 2026-07-28 (task-0728) 例外: 配置模板 /config/config-templates 路由已删除 (组件文件保留),
//   BOM 页签入口已从主数据维护壳页摘除 (V6BomQueryTab.tsx 文件保留)
