...
| `task-0806-价格调整更新任务性能优化` | ✅ **已交付合 master**（`880709fc` + T6） | 58s(18项) → 冷 JVM 实测 29.24s。`BL-0140`；**分组键必须含取价基准日**（实测反例：按 job 整批会写坏 5/18 张单）；S0 守卫开关默认关。遗留 [[BL-0144]] T5 转二期 / [[BL-0145]] 价格分叉排查 |
