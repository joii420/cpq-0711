...
- 环境：分支 `feat/task-0812-核价导入停用四个Sheet`（worktree `/home/joii/project/cpq/.claude/worktrees/task-0812-disable-4-sheets`），基于 commit **`f551f37e`**（= 本任务的"停用前"基线 commit，A/B 对照一律以它为 A 侧）
