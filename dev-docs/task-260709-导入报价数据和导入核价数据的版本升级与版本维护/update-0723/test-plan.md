...
> 重跑本测试计划时，请把相关查询改为 `SELECT ... FROM material_master WHERE pending_quotation_id = :qid`。口径见 `dev-docs/task-260708-导入报价单和导入核价单的数据落库规则澄清/repair-260726-BOM中料件类投入料号没有落库/需求说明.md`。
