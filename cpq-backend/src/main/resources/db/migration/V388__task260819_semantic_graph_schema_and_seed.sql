...
CREATE INDEX idx_semantic_edge_from ON semantic_edge(from_node_id);
CREATE INDEX idx_semantic_edge_to ON semantic_edge(to_node_id);
CREATE INDEX idx_semantic_tvn_view ON semantic_tab_view_node(view_id);
CREATE INDEX idx_semantic_tvc_view ON semantic_tab_view_column(view_id);
...
ALTER TABLE component_sql_view ADD COLUMN builder_config JSONB;
ALTER TABLE component_sql_view ADD COLUMN builder_version INT;
