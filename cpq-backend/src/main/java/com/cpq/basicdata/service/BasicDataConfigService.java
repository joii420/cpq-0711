...
public class BasicDataConfigService {
    ...
    // task-0723 B5: V5/import-session 死链路退役 — invalidateImportCache() 已删除
    // (原用于通知 BasicDataImportServiceV5 重载进程内缓存, 该类已整体退役;
    // basicdata.v6 导入路径不依赖此进程内缓存)。调用点改为空操作内联，见下方各方法。
