...
- **状态**：🚧 **开发中**（`dev-docs/task-0813-基础资料数值列扩至12位小数/`，分支 `feat/task-0813-basicdata-scale12`，闸门 A 已过）
- **登记日期**：2026-08-13
...
- **交付**：`dev-docs/task-0801-公式计算精度优化/task-0810-公式计算12位显示9位/repair-0811-输入值原样与结果精度分层/`；输入字段原值、公式 12/9 位分层、产品小计/报价总额独立精度入口全部落地，无 DDL/Flyway。
